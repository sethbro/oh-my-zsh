...
# primary prompt
PROMPT='$fg_bold[black]________________________________________________________________________%{$reset_color%}
...
# git settings
ZSH_THEME_GIT_PROMPT_PREFIX=" $fg[black]|%{$reset_color%} $fg_no_bold[yellow]"
